...
/**
 * CommandExecutor implementation for the
 * <code>/blockstore (check|info|reload)</code>.
 */
public class BlockStoreCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String labels, String[] args) {
        ...
        /*
         * if(args[0].equalsIgnoreCase("test")) { sender.sendMessage(
         * colour("&cThis command should not be available in a release version."
         * ));
         * 
         * Player player = (Player) sender; Block block =
         * player.getTargetBlock(transparentBlocks, 80);
         * 
         * if (block == null || block.getType() == Material.AIR) {
         * sender.sendMessage(
         * colour("&4Error > &cYou must be looking at a block within 80 blocks of you"
         * )); return true; }
         * 
